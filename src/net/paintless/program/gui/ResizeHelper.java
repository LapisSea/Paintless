...
public class ResizeHelper{
	...
	public static void addResizeListener(int borderSize, Stage stage){
		ResizeListener resizeListener=new ResizeListener(borderSize, stage);
	...
	static class ResizeListener implements EventHandler<MouseEvent>{
		...
		public ResizeListener(int border, Stage stage){
			this.stage=stage;
			this.border=border;
		}
